...
const TryItem = memo(({item, index, movie, expandedTries, setExpandedTries}) => {
  ...
  return (
    <div className='p-2 border-2 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 shadow-sm animate-slideIn hover:shadow-md dark:hover:shadow-gray-700 transition-shadow cursor-pointer' style={{animationDelay: `${index * 50}ms`}} onClick={toggleExpand}>
